...
# from curvefit_code_3a import *
from project3 import *
from gui_second import *


layout = [[sg.Text('Turn off Switching Loss Calculator for SiC MOSFET and Schottky Diode Pair', auto_size_text=False,
    ...
    # if all values are set properly ,b value is set to 2
            if b == 2:
                ...
                if (r_gext + r_gint) <= (2 * l_s / c_iss) ** .5:
                    ...
                    k1b, k2b, m1b, k1a, k2a, m1a, vtd = reverse_transfer_capacitance(
